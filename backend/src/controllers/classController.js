...
async function getClassIdHandler(req, res, next) {
    try {
        const { id } = req.params;
        const { id: userId, role } = req.user;
...
async function postClassHandler(req, res, next) {
    try {
...
async function patchClassIdHandler(req, res, next) {
    try {
        const { id } = req.params;
        const { title, description } = req.body;
        const { id: userId, role } = req.user;
...
async function deleteClassIdHandler(req, res, next) {
    try {
        const { id } = req.params;
        const { id: userId, role } = req.user;
